    ...
    const fetchData = async () => {
      try {
        ...
        if (!response.success) {
          ...
          console.log("call start",response.data.historyId,exam);
          if(exam?.historyId ===response.data.historyId){
    ...
    <div style={styles.container}>
      ...
      {exam &&       <Row  gutter={16}>
        <Col style={{...styles.mainCol,...styles.stickyPosition}} span={6}>
          <ExamInformation detailExam={detailExam} setIsLoading={setIsLoading}></ExamInformation>
        </Col>
